...
import com.project.webchat.user.security.UserGatewayAuthFilter;
...
public class SecurityConfig {
    ...
    private final UserGatewayAuthFilter userGatewayAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterBefore(userGatewayAuthFilter, UsernamePasswordAuthenticationFilter.class);
