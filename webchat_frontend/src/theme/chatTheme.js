...
export function createChatTheme(themeColors) {
  return createTheme({
    palette: {
      mode: 'dark',
      primary: {
    ...
    components: {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          containedPrimary: {
            boxShadow: 'none',
            '&:hover': { boxShadow: themeColors.primaryButtonHoverShadow },
          },
        },
      },
      MuiIconButton: {
      ...
      MuiBackdrop: {
        styleOverrides: {
          root: {
            backgroundColor: themeColors.backdropBg,
...
/** Default theme (purple) — prefer ChatThemeProvider for runtime switching. */
